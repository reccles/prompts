...
```
Read the prompt library index at https://github.com/reccles/prompts/blob/main/AGENTS.md and identify which prompts are relevant to my task. Then load and apply those specific prompts.
```
...
```
Read the prompt library index at https://github.com/reccles/prompts/blob/main/AGENTS.md and describe what prompts are available and when to use each one. Walk through the structure to help me understand what this library can do.
```
